/* Generated by Cython 0.16 on Sat Jun  2 21:10:04 2012 */
...
#endif
#include <math.h>
#define __PYX_HAVE__resize
#define __PYX_HAVE_API__resize
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'resize' */
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "resize"
int __pyx_module_is_main_resize = 0;
...
static PyObject *__pyx_pf_6resize_resize(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_old_center, PyObject *__pyx_v_term_dict, PyObject *__pyx_v_new, PyObject *__pyx_v_old); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_6resize_1resize(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_6resize_1resize = {__Pyx_NAMESTR("resize"), (PyCFunction)__pyx_pw_6resize_1resize, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pw_6resize_1resize(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_self = __pyx_self;
  {
    ...
    __pyx_v_term_dict = ((PyObject*)values[1]);
    __pyx_v_new = ((PyObject*)values[2]);
    __pyx_v_old = ((PyObject*)values[3]);
  }
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("resize.resize", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_term_dict), (&PyDict_Type), 1, "term_dict", 1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_new), (&PyList_Type), 1, "new", 1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_old), (&PyList_Type), 1, "old", 1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_6resize_resize(__pyx_self, __pyx_v_old_center, __pyx_v_term_dict, __pyx_v_new, __pyx_v_old);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = NULL;
  __pyx_L0:;
 ...
 * def resize(np.ndarray[double, ndim=1] old_center, dict term_dict, list new, list old):             # <<<<<<<<<<<<<<
 *   cdef int length = len(new)
 *   cdef np.ndarray[double, ndim=1] new_center = np.zeros([length])
 */

static PyObject *__pyx_pf_6resize_resize(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_old_center, PyObject *__pyx_v_term_dict, PyObject *__pyx_v_new, PyObject *__pyx_v_old) {
  int __pyx_v_length;
 ...
 */
  if (unlikely(((PyObject *)__pyx_v_new) == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "object of type 'NoneType' has no len()"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;} 
  }
  __pyx_t_1 = PyList_GET_SIZE(((PyObject *)__pyx_v_new)); 
 ...
 */
    if (!(likely(PyUnicode_CheckExact(PyList_GET_ITEM(__pyx_v_new, __pyx_v_i)))||((PyList_GET_ITEM(__pyx_v_new, __pyx_v_i)) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected unicode, got %.200s", Py_TYPE(PyList_GET_ITEM(__pyx_v_new, __pyx_v_i))->tp_name), 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_INCREF(PyList_GET_ITEM(__pyx_v_new, __pyx_v_i));
    __Pyx_XDECREF(((PyObject *)__pyx_v_term));
    __pyx_v_term = ((PyObject*)PyList_GET_ITEM(__pyx_v_new, __pyx_v_i));
 ...
 */
    __pyx_t_8 = ((PySequence_Contains(((PyObject *)__pyx_v_old), ((PyObject *)__pyx_v_term)))); if (unlikely(__pyx_t_8 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (__pyx_t_8) {
 ...
 */
      __pyx_t_3 = __Pyx_PyDict_GetItem(((PyObject *)__pyx_v_term_dict), ((PyObject *)__pyx_v_term)); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
...
#endif
{
  ...
  if (__pyx_module_is_main_resize) {
 ...
 *   cdef np.ndarray[double, ndim=1] new_center = np.zeros([length])
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6resize_1resize, NULL, __pyx_n_s__resize); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init resize", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init resize");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
