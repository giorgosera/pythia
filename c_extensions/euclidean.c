/* Generated by Cython 0.16 on Wed May 30 08:51:27 2012 */
...
#endif
#include <math.h>
#define __PYX_HAVE__src__c_extensions__euclidean
#define __PYX_HAVE_API__src__c_extensions__euclidean
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'src.c_extensions.euclidean' */
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "src.c_extensions.euclidean"
int __pyx_module_is_main_src__c_extensions__euclidean = 0;

/* Implementation of 'src.c_extensions.euclidean' */
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_3src_12c_extensions_9euclidean_distance(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_ex1, PyArrayObject *__pyx_v_ex2); /* proto */
...
static char __pyx_k_15[] = "/home/george/virtualenvfyp/pythia/src/c_extensions/euclidean.pyx";
static char __pyx_k_16[] = "src.c_extensions.euclidean";
...
static char __pyx_k__el1[] = "el1";
static char __pyx_k__el2[] = "el2";
...
static PyObject *__pyx_n_s__el1;
static PyObject *__pyx_n_s__el2;
...
/* Python wrapper */
static PyObject *__pyx_pw_3src_12c_extensions_9euclidean_1distance(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_3src_12c_extensions_9euclidean_1distance = {__Pyx_NAMESTR("distance"), (PyCFunction)__pyx_pw_3src_12c_extensions_9euclidean_1distance, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pw_3src_12c_extensions_9euclidean_1distance(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely(values[1])) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("distance", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "distance") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
  ...
  __Pyx_RaiseArgtupleInvalid("distance", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("src.c_extensions.euclidean.distance", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_ex1), __pyx_ptype_5numpy_ndarray, 1, "ex1", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_ex2), __pyx_ptype_5numpy_ndarray, 1, "ex2", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_3src_12c_extensions_9euclidean_distance(__pyx_self, __pyx_v_ex1, __pyx_v_ex2);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = NULL;
  __pyx_L0:;
...
/* "src/c_extensions/euclidean.pyx":13
...
static PyObject *__pyx_pf_3src_12c_extensions_9euclidean_distance(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_ex1, PyArrayObject *__pyx_v_ex2) {
  int __pyx_v_length;
  double __pyx_v_sum;
  double __pyx_v_el1;
  double __pyx_v_el2;
  ...
  __pyx_pybuffernd_ex2.rcbuffer = &__pyx_pybuffer_ex2;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_ex1.rcbuffer->pybuffer, (PyObject*)__pyx_v_ex1, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_ex2.rcbuffer->pybuffer, (PyObject*)__pyx_v_ex2, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "src/c_extensions/euclidean.pyx":14
 * @cython.cdivision(True)
 * def distance(np.ndarray[double, ndim = 1] ex1, np.ndarray[double, ndim = 1] ex2):
 *   cdef int length = ex1.size             # <<<<<<<<<<<<<<
 * 
 *   cdef double sum = 0
 */
  __pyx_t_1 = PyObject_GetAttr(((PyObject *)__pyx_v_ex1), __pyx_n_s__size); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyInt_AsInt(__pyx_t_1); if (unlikely((__pyx_t_2 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_length = __pyx_t_2;

  /* "src/c_extensions/euclidean.pyx":16
 *   cdef int length = ex1.size
 * 
 *   cdef double sum = 0             # <<<<<<<<<<<<<<
 *   cdef double el1 = 0
 ...
 */
  ...
  /* "src/c_extensions/euclidean.pyx":17
 * 
 *   cdef double sum = 0
 *   cdef double el1 = 0             # <<<<<<<<<<<<<<
 *   cdef double el2 = 0
 ...
 */
  ...
  /* "src/c_extensions/euclidean.pyx":18
 *   cdef double sum = 0
 *   cdef double el1 = 0
 *   cdef double el2 = 0             # <<<<<<<<<<<<<<
 *   for i in range(length):
 ...
 */
  ...
  /* "src/c_extensions/euclidean.pyx":19
 *   cdef double el1 = 0
 *   cdef double el2 = 0
 *   for i in range(length):             # <<<<<<<<<<<<<<
 *     el1 = ex1[i]
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "src/c_extensions/euclidean.pyx":20
 *   cdef double el2 = 0
 *   for i in range(length):
 *     el1 = ex1[i]             # <<<<<<<<<<<<<<
 *     el2 = ex2[i]
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    __pyx_v_el1 = (*__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_ex1.rcbuffer->pybuffer.buf, __pyx_t_4, __pyx_pybuffernd_ex1.diminfo[0].strides));

    /* "src/c_extensions/euclidean.pyx":21
 *   for i in range(length):
 *     el1 = ex1[i]
 *     el2 = ex2[i]             # <<<<<<<<<<<<<<
 *     sum += (el1-el2)*(el1-el2)
 ...
 */
    __pyx_t_5 = __pyx_v_i;
    __pyx_v_el2 = (*__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_ex2.rcbuffer->pybuffer.buf, __pyx_t_5, __pyx_pybuffernd_ex2.diminfo[0].strides));

    /* "src/c_extensions/euclidean.pyx":22
 *     el1 = ex1[i]
 *     el2 = ex2[i]
 *     sum += (el1-el2)*(el1-el2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_sum = (__pyx_v_sum + ((__pyx_v_el1 - __pyx_v_el2) * (__pyx_v_el1 - __pyx_v_el2)));
  }

  /* "src/c_extensions/euclidean.pyx":24
 *     sum += (el1-el2)*(el1-el2)
 * 
 *   cdef double dist = c_sqrt(sum)             # <<<<<<<<<<<<<<
 *   return dist
 */
  __pyx_v_dist = sqrt(__pyx_v_sum);

  /* "src/c_extensions/euclidean.pyx":25
 * 
 *   cdef double dist = c_sqrt(sum)
 *   return dist             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_dist); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__el1, __pyx_k__el1, sizeof(__pyx_k__el1), 0, 0, 1, 1},
  {&__pyx_n_s__el2, __pyx_k__el2, sizeof(__pyx_k__el2), 0, 0, 1, 1},
 ...
 * 
 */
  __pyx_k_tuple_13 = PyTuple_New(8); if (unlikely(!__pyx_k_tuple_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 2, ((PyObject *)__pyx_n_s__length));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__length));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__sum));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 3, ((PyObject *)__pyx_n_s__sum));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__sum));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__el1));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 4, ((PyObject *)__pyx_n_s__el1));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__el1));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__el2));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 5, ((PyObject *)__pyx_n_s__el2));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__el2));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__i));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 6, ((PyObject *)__pyx_n_s__i));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__i));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__dist));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 7, ((PyObject *)__pyx_n_s__dist));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__dist));
  __Pyx_GIVEREF(((PyObject *)__pyx_k_tuple_13));
  __pyx_k_codeobj_14 = (PyObject*)__Pyx_PyCode_New(2, 0, 8, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_k_tuple_13, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_15, __pyx_n_s__distance, 13, __pyx_empty_bytes); if (unlikely(!__pyx_k_codeobj_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initeuclidean(void); /*proto*/
PyMODINIT_FUNC initeuclidean(void)
#else
PyMODINIT_FUNC PyInit_euclidean(void); /*proto*/
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_euclidean(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("euclidean"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_src__c_extensions__euclidean) {
  ...
  /* "src/c_extensions/euclidean.pyx":2
 ...
 */
  ...
  /* "src/c_extensions/euclidean.pyx":3
 * from __future__ import division
 * import numpy as np
 * import math as m             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3src_12c_extensions_9euclidean_1distance, NULL, __pyx_n_s_16); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__distance, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "src/c_extensions/euclidean.pyx":1
 * from __future__ import division             # <<<<<<<<<<<<<<
 * import numpy as np
 * import math as m
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init src.c_extensions.euclidean", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init src.c_extensions.euclidean");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
